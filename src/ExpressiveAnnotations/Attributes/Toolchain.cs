...
namespace ExpressiveAnnotations.Attributes
{
    ...
    {        
        ...
        public static void RegisterMethods(this Parser parser)
        {
            ...
            parser.AddFunction<string, bool>("IsDigitChain", str => str != null && Regex.IsMatch(str, @"^\d+$", RegexOptions.Compiled));
            parser.AddFunction<string, bool>("IsNumber", str => str != null && Regex.IsMatch(str, @"^[\+-]?\d*\.?\d+(?:[eE][\+-]?\d+)?$", RegexOptions.Compiled));
