...
{
    [TestClass]
    public class RequiredIfIssueDerivedClassesWithValidationOnBase
    {
        public abstract class ModelBase
        {
            [RequiredIf("SomeOtherValue > 1")]
        ...
        {
            var firstDerived = new FirstDerived { SomeValue = null, SomeOtherValue = 0 };
            var secondDerived = new SecondDerived { SomeValue = null, SomeOtherValue = 0 };
