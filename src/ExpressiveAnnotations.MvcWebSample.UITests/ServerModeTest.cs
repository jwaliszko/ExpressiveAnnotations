...
namespace ExpressiveAnnotations.MvcWebSample.UITests
{
 ...
 (Double Backslash)";
        ...
        [Fact]
        public void select_one_donation_without_currency_if_not_going_abroad_and_verify_error_for_donations_in_server_mode()
        {
            Watch(() =>
            {
                Home.ClickCheckbox("GoAbroad");
        ...
        [Fact]
        public void select_two_donations_without_currency_if_going_abroad_and_verify_error_for_donations_in_server_mode()
        {
            Watch(() =>
            {
        ...
        [Fact]
        public void select_three_donations_without_currency_if_going_abroad_and_verify_currency_error_in_server_mode()
        {
            Watch(() =>
            {
                Home.ClickCheckbox("SelectedDonations", "1");
        ...
        [Fact]
        public void select_three_donations_with_currency_if_going_abroad_and_verify_no_error_for_donations_in_server_mode()
        {
            Watch(() =>
            {
                Home.ClickCheckbox("SelectedDonations", "1");
        ...
        [Fact]
        public void write_a_few_letters_in_comment_field_and_verify_less_priority_error_for_comment_in_server_mode()
        {
            Watch(() =>
            {
        ...
        [Fact]
        public void change_culture_write_a_few_letters_in_comment_field_and_verify_less_priority_error_for_comment_in_server_mode()
        {
            Watch(() =>
            {
                Home.SetLang("pl");
        ...
        [Fact]
        public void write_a_bit_more_letters_in_comment_field_and_verify_higher_priority_error_for_comment_in_server_mode()
        {
            Watch(() =>
            {
        ...
        [Fact]
        public void change_culture_write_a_bit_more_letters_in_comment_field_and_verify_higher_priority_error_for_comment_in_server_mode()
        {
            Watch(() =>
            {
                Home.SetLang("pl");
